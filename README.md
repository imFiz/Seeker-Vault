...
Official builds are gated through Solana's trust channels. The release **APK SHA-256** is published in this README — anyone can verify the binary they're installing matches the signed release.
